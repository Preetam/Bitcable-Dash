...
mail($userEmail, 'VPS Deployed', "
Your KVM has been deployed. The root password is: $rootPassword. Remember to change this immediately!
...
This is an automated message sent by Dash.
","From: no-reply@bitcable.com");
?>
