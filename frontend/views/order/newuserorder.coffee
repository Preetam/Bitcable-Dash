...
form id: 'orderForm', action: '/order', method: 'post', ->
	...
	for field in fields
		...
		div class: 'fieldContainer', ->
			input name: field[0], class: 'textInput', id: "#{field[0]}Field", type: (if field[0].indexOf('password') isnt -1 then "password" else "text"), maxlength: (if field[0] is 'zip' then 5 else 25)
	...
	input type: 'submit', class: 'submitButton', value: "Let's roll.", onclick: 'verifyForm(); return false'
